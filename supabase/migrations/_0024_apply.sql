-- ============================================================================
-- Kiraya - migration 0024.
--
--   0024  INTENTS FOR ANY ROLE: tenant_intents never had a role gate in its
--         policies - the tenant-only rule lived in three app redirects. They
--         are gone, so an owner between places or a broker who is moving can
--         say what they are looking for and receive suggestions. The one new
--         invariant is that you cannot suggest a listing to your own intent.
--
-- Your database already has 0001-0023. Paste into the Supabase SQL editor and
...
drop trigger if exists broker_suggestions_guard_biu on public.broker_suggestions;
