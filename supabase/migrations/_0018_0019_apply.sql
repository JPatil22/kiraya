-- ============================================================================
-- Kiraya — migrations 0018 + 0019.
--
--   0018  fixes v_listing_engagement, which returned nothing under
--         service-role (i.e. in open mode) because it was scoped on auth.uid()
--   0019  AREAS: neighbourhoods inside the locality, plus the feed filter,
--         area-aware price comparison, and area-aware intent matching.
--         Seeds 12 Pune areas and backfills existing listings from their
--         address lines.
--
-- Your database already has 0001–0017. Paste into the Supabase SQL editor and
-- Run. 0019 drops and recreates v_listings_public, which is expected.
-- ============================================================================
