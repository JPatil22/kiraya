-- ============================================================================
-- Kiraya - migration 0028.
--
--   0028  AREA CENTRES: latitude/longitude on `areas`, seeded for all twelve
--         Pune areas, so the map opens on the area the poster chose instead of
--         the middle of the city, and place search is biased there.
--
-- Your database already has 0001-0027. Paste into the Supabase SQL editor and
-- Run. Safe to run more than once. (If you already ran the earlier copy of this
-- file, nothing further is needed - only the comments changed.)
-- ============================================================================
