-- ============================================================================
-- Kiraya — migration 0012 ONLY (notifications).
-- Your database already has 0001–0011. Paste this into the Supabase SQL editor
-- (Project -> SQL Editor -> New query -> Run). Run once — it creates an enum,
-- a table, six trigger functions and their triggers.
-- ============================================================================
