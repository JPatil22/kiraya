-- ============================================================================
-- Kiraya — migration 0010 ONLY (contact exchange).
-- Your database already has 0001–0009. Paste this into the Supabase SQL editor
-- (Project -> SQL Editor -> New query -> Run). Run once — it creates a type,
-- a table, a trigger and four policies.
-- ============================================================================
