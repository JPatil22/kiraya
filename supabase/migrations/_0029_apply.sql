-- ============================================================================
-- Kiraya - migration 0029.
--
--   0029  THE REST OF PUNE: 38 more areas, taking the list from 12 to 50, plus
--         a `zone` column so a fifty-item dropdown groups the way people think
--         about the city rather than running alphabetically from Akurdi to
--         Yerwada. Adds the old city and peths, the southern and south-western
--         belt (Karve Nagar, Narhe, Ambegaon, Swargate, Warje, Katraj), the
--         eastern corridor out to Wagholi, the NIBM/Kondhwa side, and PCMC.
--
-- Your database already has 0001-0028. Paste into the Supabase SQL editor and
-- Run. Safe to run more than once - the insert is ON CONFLICT DO NOTHING.
-- ============================================================================
