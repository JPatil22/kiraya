-- ============================================================================
-- Kiraya — migration 0008 ONLY (structured photos by room).
-- Your database already has 0001–0007. Paste this into the Supabase SQL editor
-- (Project -> SQL Editor -> New query -> Run). Safe to run once.
-- ============================================================================
